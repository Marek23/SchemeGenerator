...
import pl.com.cs.schema.pointer.FuseChildPointer;
import pl.com.cs.schema.Point;

import static pl.com.cs.config.Images.getImage;

public class FuseChild extends Drawable {
	private static final float yParentMargin = 6f;

	public FuseChild(Page page, FuseMain main, float x, float y, boolean linkToMainDc24) {
		this.name       = "FuseChild";
		...
		this.main = main;
		new FuseChildPointer(main, this);
	}
}
